	...
	public class BanSystem
	{
		...
		public static async Task DoDiscordBanCommand(CommandContext context)
        {
           ...
           // await context.Channel.SendMessageAsync("asdasdasd");
            ...
            coll.Add("server", "N/A");
            coll.Add("timestamp", DateTime.UtcNow.Year.ToString("0000") + "-" + DateTime.UtcNow.Month.ToString("00") + "-" + DateTime.UtcNow.Day.ToString("00") + "T" + DateTime.UtcNow.Hour.ToString("00") + ":" + DateTime.UtcNow.Minute.ToString("00") + ":" + DateTime.UtcNow.Second + "." + DateTime.UtcNow.Millisecond.ToString("000"));
            ...
            coll.Add("duration", (span.Days >= 18250) ? "Permanent" : (span.Days + " days, " + span.Hours + " hours, and " + span.Minutes + ((span.Minutes != 1) ? " minutes." : " minute.")));
            ...
            if (player == null) { await context.Channel.SendMessageAsync("ERROR Player is null."); return; }
